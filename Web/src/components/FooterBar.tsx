...
function FooterBar({ isMobile }: { isMobile: boolean }) {
  return (
    <>
      {/* If is mobile, display content in a column layout: (email and follow me) + (copyright) */}
      {isMobile ? (
        <div className="w-full h-[8rem] bg-gray-100 flex flex-col items-center justify-around px-[min(40px,5vw)]">
        ...
        // If not mobile, display content in a row layout: (email) + (follow me) + (copyright)
